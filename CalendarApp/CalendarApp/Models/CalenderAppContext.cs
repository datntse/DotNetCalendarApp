...
{
    public partial class CalenderAppContext : DbContext
    {
		private readonly ApplicationDbContext _applicationDbContext;
		public CalenderAppContext(DbContextOptions<CalenderAppContext> options, ApplicationDbContext applicationDbContext)
            : base(options)
        {
